...
<html>
 <head>
	...
	<!-- Icon -->
	<link rel="shortcut icon" type="image/icon" href="../ids.ico">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="active"><a href="index.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
			        <li><a href="gejala.php"><i style="font-size:15px" class="fa">&#xf07c;</i><span>Helpdesk TCU</span></a></li>
			         <!-- <li><a href="kerusakan.php"><i style="font-size:16px" class="fa">&#xf013;</i></i><span>Kerusakan</span></a></li>
